...
Portfólio pessoal desenvolvido com **HTML5, CSS3 e JavaScript puro**, sem o uso de frameworks ou bibliotecas externas. O site apresenta informações profissionais, formação acadêmica, projetos desenvolvidos e um formulário de contato funcional.
...
- **CSS3** — Estilização, variáveis de tema, Flexbox, Grid e animações
- **JavaScript** (puro, sem frameworks) — Interatividade e validações
- **Formspree** — Serviço gratuito para envio real do formulário de contato
...
- ✅ Navegação entre 4 páginas com menu fixo responsivo
...
├── main.js          # JavaScript global (tema + menu mobile)
...
Este projeto foi desenvolvido para fins educacionais — **UNINTER, 2025**.
